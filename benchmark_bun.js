// Bun FS Operations Benchmark (equivalent to Ion benchmark)
...
console.log("=== Bun FS Operations Benchmark ===\n");
...
Bun.write(testFile1, "Hello from Bun FS!");
Bun.write(testFile2, "This is test file 2");
Bun.write(testFile3, "And this is test file 3 with more content for testing");
...
// Benchmark functions
console.log("🏁 Running Bun benchmarks...\n");
...
Bun.write(smallFile, "Small file content for testing");
Bun.write(mediumFile, "A".repeat(10000));
Bun.write(largeFile, "B".repeat(100000));
...
for (let i = 0; i < 100; i++) {
    ...
    Bun.write(truncFile, "A".repeat(1000));
